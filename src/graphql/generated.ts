...
export type LessonCreateInput = {
  ...
  lessonType: LessonType;
  posterImage?: InputMaybe<Scalars['String']>;
  slug: Scalars['String'];
...
export type LessonManyWhereInput = {
  ...
  posterImage?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  posterImage_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  posterImage_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  posterImage_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values that are not equal to given value. */
  posterImage_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  posterImage_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  posterImage_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  posterImage_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  posterImage_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  posterImage_starts_with?: InputMaybe<Scalars['String']>;
  publishedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export enum LessonOrderByInput {
  ...
  PosterImageAsc = 'posterImage_ASC',
  PosterImageDesc = 'posterImage_DESC',
  PublishedAtAsc = 'publishedAt_ASC',
  PublishedAtDesc = 'publishedAt_DESC',
  SlugAsc = 'slug_ASC',
  SlugDesc = 'slug_DESC',
...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, posterImage?: string | null, teacher?: { __typename?: 'Teacher', name: string, avatarURL: string, bio: string } | null } | null };
